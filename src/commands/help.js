    ...
    run: (client, message, args, storage) => {
      ...
      .then(async (msg) => {
        ...
        // Catch reactions
          ...
          let chooseFaqs = msg.createReactionCollector(faqsFilter, { time: 30000 });
          let chooseCommands = msg.createReactionCollector(commandsFilter, { time: 30000 });
          let chooseEmojiLibrary = msg.createReactionCollector(emojiLibraryFilter, { time: 30000 });        
        ...
        chooseCommands.on("collect", async(r) => {
          r.users.remove(message.author)
          commandsEmbed = new Discord.MessageEmbed()
          .setTitle("Emoter commands")
